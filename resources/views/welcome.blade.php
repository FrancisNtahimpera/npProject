...
<div class=" wrapper">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="/">HOUSE FOR YOU </a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            @if (Auth::user())
            <div class="nav-item">
                <span class="nav-link" href="">Salut {{ Auth::user()->name }}</span>
              </div>
              @csrf
              <div class="nav-item">
                <a class="nav-link" href="/favoris">FAV</a>
              </div>
              <div class="nav-item">
              ...
              @else
              <div class="nav-item">
                <a class="nav-link" href="/login">CONNEX</a>
              </div>
              <div class="nav-item">
